package cn.com.auth.redis.impl;
...
public class RedisUtilImpl implements RedisUtil {
    ...
    @Autowired
    public RedisUtilImpl(RedisTemplate<String, String> redisTemplate) {
     ...
     */
    @Override
    public boolean setStrWithExpiredTime(String key, String value, long time) {
        try {
            ...
            LOGGER.error("set data 2 redis is error,key:{},val{}", key, value, t);
        }
        return false;
    }
    ...
    @Override
    public void hPutObj(String key, Object hashKey, Object value) {
        redisTemplate.opsForHash().put(key, hashKey, value);
    }
     ...
     */
    @Override
    public void hPutAllByObj(String key, Map<Object, Object> maps) {
        redisTemplate.opsForHash().putAll(key, maps);
    }

    @Override
    public void setHashAll(String key, Map<String, String> maps) {
        hPutAll(key, maps);
    }
